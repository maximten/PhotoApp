...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    _this.doSearch = _this.handleClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
    ...
    value: function render() {
      ...
      if (this.state.photos == null) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          ...
          id: "btn1",
          onClick: this.doSearch(this.refs.name),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 51
          },
          ...
          __self: this
        }, this.state.photos.map(function (item, key) {
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
            className: "card",
            __source: {
              fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.17de7664643568303502.hot-update.js.map